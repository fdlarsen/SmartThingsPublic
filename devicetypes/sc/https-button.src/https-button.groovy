...
metadata {
	definition (name: "HTTPS Button", namespace: "sc", author: "SC") {
	capability "Actuator"
        capability "Switch"
	...
	preferences {
		...
		input(name: "DevicePostGet", type: "enum", title: "PUT, POST or GET", options: ["PUT","POST","GET"], defaultValue: "POST", required: false, displayDuringSetup: true)
		section() {
            ...
            input("AuthToken", "string", title:"Auth Token", description: "Enter your Token", required: false, displayDuringSetup: true)
		}
	}
